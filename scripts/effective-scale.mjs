 ...
 *
 * 例:
 *   node scripts/effective-scale.mjs .airis/work/push/my-repo
 *   node scripts/effective-scale.mjs .airis/work/push/my-repo spacing:13px radius:5px text:15px weight:620 bp:1200px
 *
